...
<div class="section_w560">
  	    ...
  	    <center>
    <h2>修改员工信息</h2>
    	<form action="<%=basePath%>employee/Employee_wel!doUpdate" method="post">
    		<table>
    		 <s:iterator value="#session.employee" id="emp">
    			
    			<tr>	<td>员工编号:<input type="text" name="employee.staff_id" value="<s:property value="#emp.staff_id"/>"></td><tr/>
    			<tr>	<td>员工姓名:<input type="text" name="employee.staff_name" value="<s:property value="#emp.staff_name"/>"></td></tr>
    			<tr>	<td>员工岗位:<input type="text" name="employee.section.section_id" value="<s:property value="#emp.section.section_id"/>"></td>
    			<tr>	<td>员工职位:<input type="text" name="employee.position.position_id" value="<s:property 

value="#emp.position.position_id"/>"></td>
    			<tr>	<td>入职时间:<sx:datetimepicker name="employee.staff_entryapplytime" label="请选择" displayFormat="yyyy-mm-dd"/></td>
    			<!--  <tr>	<td>入职情况:<input type="text" name="employee.staff_entrycondition" value="<s:property 

value="#emp.staff_entrycondition"/>"></td>-->
<tr>	<td>入职情况:<select name="employee.staff_entrycondition">
   			<option value="完成" >完成</option>
   			<option value="未完成" >未完成</option>
   			</select>
        </td>
    			<!-- <tr>	<td>完成时间:<input type="text" name="employee.staff_entrycomplytime" value="<s:property value="#emp.entrycomplytime"/>"></td> -->
    			 <tr>	<td>完成时间:<sx:datetimepicker name="employee.staff_entrycomplytime" label="请选择" displayFormat="yyyy-mm-dd"/></td>
    			<tr>	<td>身份证号:<input type="text" name="employee.staff_salary" value="<s:property value="#emp.staff_salary"/>"></td>
		    	</tr>
		    	...
		    	<tr>
		    		<td><input type="submit" value="修改"/>&nbsp;<input type="reset" value="重置"/>&nbsp;<input type="submit" value="返回"/></td>
		    	</tr>
		    </table>
    	</form>
    </center>
