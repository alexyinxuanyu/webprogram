...
<div class="section_w560">
                 ...
                 <form action="<%=basePath%>leave/Leave_wel!doAdd" method="post">
    	<p>员工编号:<input type="text" name="leave.staff_id"/></p>
    	<p>员工姓名:<input type="text" name="leave.staff_name"/></p>
    	<p>员工岗位:<input type="text" name="leave.section.section_id"/></p>
    	<p>员工职位:<input type="text" name="leave.position.position_id"/></p>
    	<!-- <p>离职时间:<input type="text" name="leave.staff_leaveapplytime"/></p> -->
    	<p>离职时间:<sx:datetimepicker name="leave.staff_leaveapplytime" label="请选择" displayFormat="yyyy-mm-dd"/></p>
    	<!--  <p>离职情况:<input type="text" name="leave.staff_leavecondition"/></p>-->
    	<p>离职情况:<select name="leave.staff_leavecondition">
   			<option value="完成" >完成</option>
   			<option value="未完成" >未完成</option>
   			</select>
        </p>
    	<!-- <p>完成时间:<input type="text" name="leave.staff_leavecomplytime"/></p>-->
    	<p>完成时间:<sx:datetimepicker name="leave.staff_leavecomplytime" label="请选择" displayFormat="yyyy-mm-dd"/></p>
...
<div id="templatemo_footer_wrapper">
	...
	<div id="templatemo_footer">
        ...
        Validate <a href="<%=basePath%>http://validator.w3.org/check?uri=referer">XHTML</a> &amp; 
        <a href="<%=basePath%>http://jigsaw.w3.org/css-validator/check/referer">CSS</a>
    </div> 
