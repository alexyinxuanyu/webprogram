...
<div class="section_w560">
      ...
      <form action="<%=basePath%>user/Manager_Register!toRegister.action" method="post">
   	<table >
   		<tr>
   		<td colspan="2" align="center"><h2>用户注册</h3></td>
   		</tr>
   		<tr>
   		<td>用户名</td>
	   	<td><input type="text" name="staff.staff_name"/></td>
	   </tr>
	   <tr>
	   	<td>密码</td>
	   	<td><input type="password" name="staff.staff_idcard"/></td>
	   </tr>
	   <tr>
	   	<td>部门号:</td>
	   	<td><input type="text" name="staff.section.section_id"/></td>
	   </tr>
	   <tr>
	   	<td>岗位号:</td>
	   	<td><input type="text" name="staff.position.position_id"/></td>
	   </tr>
	   <tr>
	   	<td>用户编号:</td>
	   	<td><input type="text" name="staff.staff_id"/></td>
	   </tr>
	   <tr>
	   	<td>申请权限:</td><td>
	   	<select name="staff.staff_seniority">
   			<option value="user" >user</option>
   			<option value="staff" >staff</option>
   			</select></td>
	   	<!--  <td><input type="text" name="staff.staff_seniority"/></td>-->
	   </tr>
	   <tr>
