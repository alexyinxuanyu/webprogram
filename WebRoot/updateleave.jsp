...
<div class="section_w560">
				  ...
				  <h2>修改员工信息管理</h2>
    	<form action="<%=basePath%>leave/Leave_wel!doUpdate" method="post">
    		<table>
    		 <s:iterator value="#session.leave" id="st">
    			
    			<tr>	<td>员工编号:<input type="text" name="leave.staff_id" value="<s:property value="#st.staff_id"/>"></td><tr/>
    			<tr>	<td>员工姓名:<input type="text" name="leave.staff_name" value="<s:property value="#st.staff_name"/>"></td></tr>
    			<tr>	<td>员工岗位:<input type="text" name="leave.section.section_id" value="<s:property value="#st.section.section_id"/>"></td>
    			<tr>	<td>员工职位:<input type="text" name="leave.position.position_id" value="<s:property value="#st.position.position_id"/>"></td>
    			<tr>	<td>离职时间:<sx:datetimepicker name="leave.staff_leaveapplytime" label="请选择" displayFormat="yyyy-mm-dd"/></td>
    			<tr>	<td>离职情况:<select name="leave.staff_leavecondition">
   			<option value="完成" >完成</option>
   			<option value="未完成" >未完成</option>
   			</select></td>
    			<tr>	<td>完成时间:<sx:datetimepicker name="leave.staff_leavecomplytime" label="请选择" displayFormat="yyyy-mm-dd"/></td>
		    	</tr>
		    	...
		    	<tr>
		    		<td><input type="submit" value="修改"/>&nbsp;<input type="reset" value="重置"/>&nbsp;<input type="submit" value="返回"/></td></td>
		    	</tr>
		    </table>
    	</form>       
