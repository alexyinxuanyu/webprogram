...
<div id="templatemo_content">
 ...
 <div id="main_column">
                ...
                <div class="section_w560">
                  ...
                  <h2>添加部门信息</h2>
                    <form action="<%=basePath%>section/Section_addSection!addSection" method="post">
  <table>
			<tr>
				<td>
					部门名称
			...
			<tr>
				...
				<td>
					<input type="text" name="section.section_phone" />
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<input type="text" name="section.section_fax" />
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
                    ...
                    <br/>
                    <div class="button bottom_02"></div>
