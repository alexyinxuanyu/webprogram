...
<div align="center">
    <h2>岗位修改界面</h2> 
    <form action="<%=basePath%>position/Position_Update!isUpdatePosition" method="post">
    <table>
    <s:iterator  value="#session.position" id="position" status="stat">
         <tr>
        <td>岗位编号</td><td><input type="text" name="position.position_id" value="<s:property value="#position.position_id"/>"/></td>
        </tr>
         <tr>
        <td>岗位名称</td><td><input type="text" name="position.position_name" value="<s:property value="#position.position_name"/>"/></td>
        </tr>
        <tr>
        ...
        <tr>
        <td>电话</td><td><input type="text" name="position.position_number" value="<s:property value="#position.position_number"/>"/></td>
        </tr>
        <tr>
        <td>岗位职责</td><td><input type="text" name="position.position_vacation" value="<s:property value="#position.position_vacation"/>"/></td>
        </tr>      
        <tr>       
